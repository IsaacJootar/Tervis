...
@php
    ...
    // Override config for facility admin
...
@section('layoutContent')
    <div class="layout-wrapper layout-content-navbar {{ $isMenu ? '' : 'layout-without-menu' }} facility-admin-layout">
        <div class="layout-container">

            @if ($isMenu)
                @include('layouts/sections/menu/facilityAdminMenu')
            @endif
            ...
            <div class="layout-page">
                ...
                <!-- BEGIN: Navbar-->
                @if ($isNavbar)
                    @include('layouts/sections/navbar/facilityAdminNavbar')
                @endif
                <!-- END: Navbar-->
