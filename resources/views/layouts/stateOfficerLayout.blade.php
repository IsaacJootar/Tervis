{{-- resources/views/layouts/stateOfficerLayout.blade.php --}}
@isset($pageConfigs)
...
@php
    ...
    // Override config for Sate Data Officer
...
@section('layoutContent')
    <div class="layout-wrapper layout-content-navbar {{ $isMenu ? '' : 'layout-without-menu' }} state-officer-layout">
        <div class="layout-container">

            @if ($isMenu)
                @include('layouts/sections/menu/stateOfficerMenu')
            @endif
            ...
            <div class="layout-page">
                ...
                <!-- BEGIN: Navbar-->
                @if ($isNavbar)
                    @include('layouts/sections/navbar/stateOfficerNavbar')
                @endif
                <!-- END: Navbar-->
