...
@php
    ...
    // Override config for LGA Officer(no need for now)
...
@section('layoutContent')
    <div class="layout-wrapper layout-content-navbar {{ $isMenu ? '' : 'layout-without-menu' }} lga-officer-layout">
        <div class="layout-container">

            @if ($isMenu)
                @include('layouts/sections/menu/lgaOfficerMenu')
            @endif
            ...
            <div class="layout-page">
                ...
                <!-- BEGIN: Navbar-->
                @if ($isNavbar)
                    @include('layouts/sections/navbar/lgaOfficerNavbar')
                @endif
                <!-- END: Navbar-->
