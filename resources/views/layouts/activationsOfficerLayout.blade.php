{{-- resources/views/layouts/activationsOfficerLayout.blade.php --}}
@isset($pageConfigs)
...
@php
    ...
    //if you want, you can Override default config for Data Officer's layout
...
@section('layoutContent')
    <div class="layout-wrapper layout-content-navbar {{ $isMenu ? '' : 'layout-without-menu' }} data-officer-layout">
        <div class="layout-container">

            @if ($isMenu)
                @include('layouts/sections/menu/activationsOfficerMenu')
            @endif
            ...
            <div class="layout-page">
                ...
                <!-- BEGIN: Navbar-->
                @if ($isNavbar)
                    @include('layouts/sections/navbar/activationsOfficerNavbar')
                @endif
                <!-- END: Navbar-->
    ...
    {{-- ============================================ --}}
    {{-- GLOBAL DATATABLE ALPINE COMPONENT --}}
    {{-- ============================================ --}}
    <script>
        document.addEventListener('alpine:init', () => {
            Alpine.data('dataTable', (config = {}) => ({
                ...
                initializeDataTable() {
                    ...
                    new DataTable('#' + this.tableId, finalConfig);
                }
            }));
        });
    </script>
