{{-- resources/views/layouts/patientLayout.blade.php --}}
@isset($pageConfigs)
...
@php
    ...
    // Override config for patient admin
...
@section('layoutContent')
    <div class="layout-wrapper layout-content-navbar {{ $isMenu ? '' : 'layout-without-menu' }} patient-layout">
        <div class="layout-container">

            @if ($isMenu)
                @include('layouts/sections/menu/patientMenu')
            @endif
            ...
            <div class="layout-page">
                ...
                <!-- BEGIN: Navbar-->
                @if ($isNavbar)
                    @include('layouts/sections/navbar/patientNavbar')
                @endif
                <!-- END: Navbar-->
