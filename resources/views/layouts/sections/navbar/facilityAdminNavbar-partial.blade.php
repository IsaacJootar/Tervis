...
@if (isset($navbarFull))
    <div class="navbar-brand app-brand demo d-none d-xl-flex py-0 me-4 ms-0">
        <a href="{{ url('/facility-admin-dashboard') }}" class="app-brand-link">
            ...
            <div class="dropdown-menu dropdown-menu-end py-0">
                <div class="dropdown-menu-header border-bottom">
                    <div class="dropdown-header d-flex align-items-center py-3">
                        <h5 class="text-body mb-0 me-auto">Admin Shortcuts</h5>
                        <a href="javascript:void(0)" class="dropdown-shortcuts-add text-muted" data-bs-toggle="tooltip"
                            ...
                            <i class="icon-base ti tabler-sm ti-plus text-muted"></i>
                        </a>
                    </div>
                </div>
                <div class="dropdown-shortcuts-list scrollable-container">
                    <div class="row row-bordered g-0">
                        <div class="dropdown-shortcuts-item col">
                            ...
                            <a href="#" class="stretched-link">User Management</a>
                            <small class="text-muted mb-0">Manage Users</small>
                        </div>
                        <div class="dropdown-shortcuts-item col">
                            <span class="dropdown-shortcuts-icon bg-label-secondary rounded-circle mb-2">
                                <i class="icon-base ti tabler-building-hospital fs-4"></i>
                            </span>
                            <a href="#" class="stretched-link">Facilities</a>
                            <small class="text-muted mb-0">Healthcare Facilities</small>
                        </div>
                    </div>
                    <div class="row row-bordered g-0">
                        <div class="dropdown-shortcuts-item col">
                            <span class="dropdown-shortcuts-icon bg-label-secondary rounded-circle mb-2">
                                <i class="icon-base ti tabler-chart-bar fs-4"></i>
                            </span>
                            <a href="#" class="stretched-link">System Reports</a>
                            <small class="text-muted mb-0">Analytics</small>
                        </div>
                        <div class="dropdown-shortcuts-item col">
                            <span class="dropdown-shortcuts-icon bg-label-secondary rounded-circle mb-2">
                                <i class="icon-base ti tabler-settings fs-4"></i>
                            </span>
                            <a href="#" class="stretched-link">System Settings</a>
                            <small class="text-muted mb-0">Configuration</small>
                        </div>
                    </div>
                </div>
            </div>
