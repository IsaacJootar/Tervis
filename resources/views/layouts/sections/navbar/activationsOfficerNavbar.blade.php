{{-- resources/views/layouts/sections/navbar/activationsOfficerNavbar.blade.php --}}
@php
...
@if (isset($navbarDetached) && $navbarDetached == 'navbar-detached')
    <nav class="layout-navbar {{ $containerNav }} navbar navbar-expand-xl {{ $navbarDetached }} align-items-center bg-navbar-theme central-admin-navbar"
        id="layout-navbar">
        @include('layouts/sections/navbar/activationsOfficerNavbar-partial')
    </nav>
@else
    <nav class="layout-navbar navbar navbar-expand-xl align-items-center bg-navbar-theme central-admin-navbar"
        id="layout-navbar">
        <div class="{{ $containerNav }}">@include('layouts/sections/navbar/activationsOfficerNavbar-partial')</div>
    </nav>
@endif
<!-- / Data Officer  Navbar -->
