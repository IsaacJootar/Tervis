...
@php
    ...
    // Load activations officer menu data
    $menuDataPath = resource_path('menu/activationsOfficerMenu.json');
  ...
  {{ $attribute }}="{{ $value }}" @endforeach>
    ...
    @if (!isset($navbarFull))
        <div class="app-brand demo">
            <a href="{{ route('din-activations') }}" class="app-brand-link single-logo-role">
