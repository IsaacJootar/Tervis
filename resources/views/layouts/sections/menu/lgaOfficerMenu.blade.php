...
@php
    ...
    // Load LGA officer menu data
    $menuDataPath = resource_path('menu/lgaOfficerMenu.json');
    $menuData = json_decode(file_get_contents($menuDataPath));
@endphp

<aside id="layout-menu" class="layout-menu menu-vertical menu lga-officer-menu"
