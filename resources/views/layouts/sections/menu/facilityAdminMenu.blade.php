...
@php
    ...
    // Load facility admin menu data
    $menuDataPath = resource_path('menu/facilityAdminMenu.json');
    $menuData = json_decode(file_get_contents($menuDataPath));
@endphp

<aside id="layout-menu" class="layout-menu menu-vertical menu facility-admin-menu"
        ...
        <div class="app-brand demo">
            <a href="{{ url('/core/facility-admin-dashboard') }}" class="app-brand-link">
                ...
                <span class="app-brand-text demo menu-text fw-bold ms-3">{{ config('variables.templateName') }} <small
                        class="text-muted">[Facility Admin]</small></span>
            </a>
