  ...
  <div class="footer-bottom py-3 py-md-5">
    <div class="container d-flex flex-wrap justify-content-between flex-md-row flex-column text-center text-md-start">
      ...
      <div>
        ...
        <a href="{{ config('variables.facebookUrl') }}" class="me-4 text-white" target="_blank">
          <svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
        ...
        <a href="{{ config('variables.twitterUrl') }}" class="me-4 text-white" target="_blank">
          <svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
        ...
        <a href="{{ config('variables.instagramUrl') }}" class="text-white" target="_blank">
