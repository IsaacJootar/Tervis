            ...
            <div class="modal-content">
                ...
                <div class="modal-body px-4 pb-4">
                    ...
                    <div class="alert alert-info py-2 mb-3">
                        ...
                        <button wire:click="openRegistrationModal" type="button" class="btn btn-sm btn-outline-primary"
                            data-bs-dismiss="modal" data-bs-toggle="modal" data-bs-target="#registrationModal">
                    ...
                    @if ($hasOpdRegistration)
                        <div class="verification-card verification-warning">
                            <span class="badge bg-label-warning mb-2"><i class="bx bx-info-circle me-1"></i>Registration Exists</span>
                            ...
                            <div class="alert alert-warning mt-3 mb-0">
                                Patient already has OPD registration. Open dashboard instead of creating a duplicate entry.
                            </div>
                    ...
                    @if ($isNewPatient)
                        <div class="verification-card verification-danger">
                            ...
                            <p class="mb-0">Proceed to new patient registration.</p>
                            <div class="d-grid gap-2 mt-3">
                                <button wire:click="openRegistrationModal" type="button" class="btn btn-primary"
                                    data-bs-dismiss="modal" data-bs-toggle="modal" data-bs-target="#registrationModal">
                    ...
                    @if ($isPatientVerified)
                        <div class="verification-card verification-success">
                            ...
                            <div class="d-grid gap-2 mt-3">
                                <button wire:click="openRegistrationModal" type="button" class="btn btn-success"
                                    data-bs-dismiss="modal" data-bs-toggle="modal" data-bs-target="#registrationModal">
