                    ...
                    <div class="hero-text">
                        ...
                        <div class="d-flex flex-wrap gap-3 text-white mb-1">
                            <span>
                                ...
                                <strong>Facility:</strong> {{ $facility_name ?? 'N/A' }}
                            </span>
                            <span>
                            ...
                            <span>
                                ...
                                <strong>LGA:</strong> {{ $lga_name ?? 'N/A' }}
                            </span>
                            <span>
                                <i class="bx bx-map-pin me-1"></i>
                                <strong>Ward:</strong> {{ $ward_name ?? 'N/A' }}
                            </span>
                            <span>
                        ...
                        <div class="hero-stats">
                            ...
                            <span class="hero-stat">
                                ...
                                New This Period ({{ $newRegistrations }})
                            </span>
                            <span class="hero-stat">
                                <i class="bx bx-calendar-check"></i>
                                Today's Visits ({{ $todaysAttendance }})
                            </span>
                        </div>
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h5 class="mb-0">{{ $activePregnancies }}</h5>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h5 class="mb-0">{{ $totalDeliveries }}</h5>
        ...
        <div class="col-lg-8 mb-4">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <small class="text-muted">Last {{ $selectedTimeframe }} days</small>
                </div>
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-6 mb-3">
                            <div class="border rounded p-3">
                                ...
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <h5 class="mb-0">{{ $antenatalStats['total'] }}</h5>
                                        <small class="text-muted">Total Records</small>
                                    </div>
                                    <div class="text-end">
                                        <h6 class="mb-0 text-primary">{{ $antenatalStats['this_period'] }}</h6>
                        ...
                        <div class="col-md-4 col-sm-6 mb-3">
                            <div class="border rounded p-3">
                                ...
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <h5 class="mb-0">{{ $deliveryStats['total'] }}</h5>
                                        <small class="text-muted">Total Records</small>
                                    </div>
                                    <div class="text-end">
                                        <h6 class="mb-0 text-success">{{ $deliveryStats['this_period'] }}</h6>
                                        <small class="text-muted">This Period</small>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4 col-sm-6 mb-3">
                            <div class="border rounded p-3">
                                ...
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <h5 class="mb-0">{{ $postnatalStats['total'] }}</h5>
                                        <small class="text-muted">Total Records</small>
                                    </div>
                                    <div class="text-end">
                                        <h6 class="mb-0 text-info">{{ $postnatalStats['this_period'] }}</h6>
                                        <small class="text-muted">This Period</small>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4 col-sm-6 mb-3">
                            <div class="border rounded p-3">
                                ...
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <h5 class="mb-0">{{ $tetanusStats['total'] }}</h5>
                                        <small class="text-muted">Total Records</small>
                                    </div>
                                    <div class="text-end">
                                        <h6 class="mb-0 text-warning">{{ $tetanusStats['this_period'] }}</h6>
                                        <small class="text-muted">This Period</small>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4 col-sm-6 mb-3">
                            <div class="border rounded p-3">
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div class="text-end">
                                        <h6 class="mb-0 text-secondary">{{ $attendanceStats['this_period'] }}</h6>
                                        <small class="text-muted">This Period</small>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card-body">
                        @foreach ($riskAlerts as $alert)
                            <div class="alert alert-{{ $alert['type'] }} d-flex align-items-center mb-3"
                                ...
                                <span class="badge bg-{{ $alert['type'] }} ms-2 fs-6">{{ $alert['count'] }}</span>
                            </div>
                        @endforeach
                    </div>
                </div>
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">
                        <i class="bx bx-trending-up me-2"></i>Performance Metrics
                    </h5>
                </div>
                <div class="card-body">
                    <div class="row">
                                ...
                                <div class="flex-grow-1">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            ...
                                            <br>
                                            <small class="text-muted" style="font-size: 0.75rem;">Patients registered
                                                at this facility</small>
                                        </div>
                                        <span
                        ...
                        <div class="col-md-4 mb-4">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            <small class="text-muted">Facility Care</small>
                                            <br>
                        ...
                        <div class="col-12">
                            <div class="alert alert-info d-flex align-items-center" role="alert">
                                ...
                                <div>
                                    ...
                                    @endphp
                                    @if ($avgScore >= 75)
                                        Your facility is performing very well with high coverage and strong patient
                                        engagement.
                                    @elseif($avgScore >= 50)
                                        Your facility shows good performance with room for improvement in patient
                                        engagement.
                                    @else
                                        Consider strategies to improve patient coverage and visit frequency for better
                                        care outcomes.
                                    @endif
                                </div>
                            </div>
