<div class="dashboard-container">
        ...
        <div class="col-lg-8 mb-4">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="card-title mb-0">State-Wide Trends Over Time</h5>
    ...
    @if (!empty($lgaBreakdown))
        <div class="row mb-4">
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">
                            <i class="bx bx-map-alt me-2"></i>LGA Performance Breakdown
                        </h5>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    @foreach ($lgaBreakdown as $lga => $data)
                                        <tr>
                            ...
                            @foreach ($topFacilities as $facility)
                                <div class="list-group-item d-flex justify-content-between align-items-center px-0">
                                    <div>
                                        ...
                                        <br>
                                        <small class="text-muted">{{ $facility['lga'] }}</small>
                                    </div>
                                    <div class="text-end">
                                        <div class="mb-1">
    ...
    <!-- Facility Performance + Report Completeness -->
    <div class="row mb-4">
        <div class="col-lg-7 mb-4">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">
                        <i class="bx bx-line-chart me-2"></i>Facility Performance Table
                    </h5>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                @forelse ($facilityPerformanceRows as $row)
                                    <tr>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="7" class="text-center text-muted py-3">No facility performance rows yet.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
        ...
        <div class="col-lg-5 mb-4">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">
                        <i class="bx bx-file-find me-2"></i>Report Submission Completeness
                    </h5>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                @forelse ($reportCompletenessRows as $row)
                                    <tr>
                                        <td>
                                            <strong>{{ $row['facility'] }}</strong>
                                            <div class="small text-muted">{{ $row['lga'] }}</div>
                                        </td>
                                        <td class="text-center">
                                            <span
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="text-center text-muted py-3">No completeness rows available.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">State-Wide Register Statistics</h5>
                </div>
                <div class="card-body">
                    <div class="row">
                ...
                <div class="card border-warning">
                    <div class="card-header bg-label-danger">
                        <h5 class="card-title mb-0">
                            ...
                            State-Wide Risk Alerts & Notifications
                        </h5>
                    </div>
                    <div class="card-body">
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">
                        <i class="bx bx-trending-up me-2"></i>State-Wide Performance Metrics
                    </h5>
                </div>
                <div class="card-body">
                    <div class="row">
                                ...
                                <div class="flex-grow-1">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            ...
                                            <br>
                                            <small class="text-muted" style="font-size: 0.75rem;">Average patients
                                                per day</small>
                                        </div>
                                        <span
                        ...
                        <div class="col-md-4 mb-4">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            <small class="text-muted">State Care Efficiency</small>
                                            <br>
                    ...
                    <div class="row mt-3">
                        <div class="col-12">
                            <div class="alert alert-info d-flex align-items-center" role="alert">
                                ...
                                <div>
                                    <strong>State Performance Summary:</strong>
                                    @php
                                        $avgScore =
                                    ...
                                    @endphp
                                    @if ($avgScore >= 75)
                                        Your state is performing very well across {{ $facilityCount ?? 0 }} facilities
                                        with high coverage and strong patient engagement.
                                    @elseif($avgScore >= 50)
                                        Your state shows good performance with room for improvement in patient
                                        engagement across facilities.
                                    @else
                                        Consider state-wide strategies to improve patient coverage and visit frequency
