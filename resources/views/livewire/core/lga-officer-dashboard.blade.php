            ...
            <div class="d-flex flex-column flex-lg-row justify-content-between align-items-start gap-3">
                <div>
                    ...
                    <div class="d-flex flex-wrap gap-2 mt-2">
                        ...
                        <span class="badge bg-label-info"><i class="bx bx-map-alt me-1"></i>{{ $lga_name ?? 'N/A' }}</span>
                        <span class="badge bg-label-dark"><i class="bx bx-building-house me-1"></i>{{ $facilityCount ?? 0 }} Facilities</span>
                        <span class="badge bg-label-success"><i class="bx bx-group me-1"></i>{{ number_format($totalPatients) }} Patients</span>
