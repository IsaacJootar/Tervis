...
<html
  ...
  <head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="../../assets/cureva-c19-green-2.png" />
          ...
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              <span class="app-brand-logo demo">
                <img src="{{ asset('assets/cureva-logo.svg') }}" alt="Cureva" style="height: 38px; width: auto;">
              </span>
            </a>
                      ...
                      <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
                          <div class="d-flex">
                            ...
                            <div class="flex-grow-1">
                              <h6 class="mb-1 small">New Message âœ‰ï¸</h6>
                        ...
                        <li class="list-group-item list-group-item-action dropdown-notifications-item">
                          <div class="d-flex">
                            ...
                            <div class="flex-grow-1">
                              <h6 class="mb-1 small">Whoo! You have new order ðŸ›’</h6>
                        ...
                        <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
                          <div class="d-flex">
                            ...
                            <div class="flex-grow-1">
                              <h6 class="mb-1 small">Application has been approved ðŸš€</h6>
              ...
              <div class="container-xxl">
                <div
                  ...
                  <div class="text-body">
                    ...
                    , made with â¤ï¸ by <a href="https://pixinvent.com" target="_blank" class="footer-link">Pixinvent</a>
                  </div>
