<div>
    ...
    @else
        <div class="mb-3"><span class="badge bg-label-primary text-uppercase">Drug Catalog</span></div>
                ...
                <div class="table-responsive">
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="text-center text-muted py-4">No catalog items yet.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
