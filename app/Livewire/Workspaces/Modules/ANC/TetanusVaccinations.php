...
#[Lazy]
class TetanusVaccinations extends Component
{
  // ============================================
  ...
  public function store()
  {
    ...
    try {
      ...
      $this->logActivity('create', "Recorded {$this->current_tt_dose} vaccination", [
        'dose' => $this->current_tt_dose,
        'dose_date' => $this->dose_date,
      ]);
  ...
  public function update()
  {
    ...
    try {
      ...
      $this->logActivity('update', "Updated {$this->current_tt_dose} vaccination", [
  ...
  public function delete($id)
  {
    ...
    try {
      ...
      $this->logActivity('delete', "Deleted {$vaccination->current_tt_dose} vaccination", [
  ...
  {
    return view('livewire.workspaces.modules.anc.tetanus-vaccinations', [
